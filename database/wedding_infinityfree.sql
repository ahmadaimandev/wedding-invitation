-- Wedding E-Invitation System - InfinityFree Version (Fixed Password)
-- Database: if0_40767466_wedding_db
-- JANGAN create database baru - guna yang sudah ada!
...
-- Username: admin
-- Password: admin123
-- Using MD5 hash for compatibility
INSERT INTO users (username, password, full_name, status) VALUES 
('admin', MD5('admin123'), 'System Administrator', 'active');
